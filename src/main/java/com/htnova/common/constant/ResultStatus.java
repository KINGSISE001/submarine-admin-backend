...
public enum ResultStatus {
    ...
    // ===============订单相关(18)=============
    ZHI_FU_ORDER(1, "已支付订单"),
    DAI_JIE_ORDER(2, "已支付待接订单"),
    QU_XIAO_ORDER(3, "商家/用户取消订单 "),
    QUE_DING_ORDER(4, "已确定订单"),
    DAI_PEI_SONG_ORDER(5, "待配送"),
    PEI_SONG_ZHONG_ORDER(6, "配送中"),
    PEI_SONG_YI_CHANG_ORDER(7, "配送异常"),
    WAN_CHENG_ORDER(8, "已完成订单"),
    YI_QU_XIAO_ORDER(9, "已取消订单"),
    // ===============业务相关(99)=============
    CUI_DAN(10, "催单"),
    TUI_KUAN(11, "退款信息"),
    JIAN_HUO(12, "拣货完成"),
