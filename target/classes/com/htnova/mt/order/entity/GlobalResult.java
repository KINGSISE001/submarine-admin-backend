...
public class GlobalResult implements Serializable {
    ...
    public static GlobalResult mt(Integer status, String msg, Integer count, Object data) {
        return new GlobalResult(status, msg, count, data);
    }
    ...
    public GlobalResult(Integer status, String msg, Integer count, Object data) {
        this.status = status;
        this.msg = msg;
        this.count = count;
        this.data = data;
